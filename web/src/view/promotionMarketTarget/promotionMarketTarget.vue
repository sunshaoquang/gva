    ...
    <div class="gva-search-box">
      ...
      >
        ...
        <el-form-item label="店铺代码" prop="shopCode">
          <el-input v-model="searchInfo.shopCode" placeholder="搜索条件" />
        </el-form-item>
        <el-form-item label="目标" prop="target">
          <el-input
            v-model.number="searchInfo.startTarget"
            placeholder="最小值"
          />
          —
          <el-input
            v-model.number="searchInfo.endTarget"
            placeholder="最大值"
          />
        </el-form-item>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column
          ...
          width="120"
        />
        <el-table-column align="left" label="目标" prop="target" width="120" />
        <el-table-column
          align="left"
          label="场景类型"
          prop="type"
        ...
        <el-table-column align="left" label="操作">
          <template #default="scope">
            ...
            <el-button
              ...
              icon="edit"
              class="table-button"
              @click="updatePromotionMarketTargetFunc(scope.row)"
              >变更</el-button
            >
            <el-button
              type="primary"
    ...
    >
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
          ...
          <el-descriptions-item label="店铺代码">
            {{ formData.shopCode }}
          </el-descriptions-item>
...
import {
  ...
  deletePromotionMarketTarget,
  deletePromotionMarketTargetByIds,
  updatePromotionMarketTarget,
  findPromotionMarketTarget,
  getPromotionMarketTargetList,
...
const getTableData = async () => {
  const table = await getPromotionMarketTargetList({
    page: page.value,
...
const deleteRow = (row) => {
  ElMessageBox.confirm("确定要删除吗?", "提示", {
    ...
    deletePromotionMarketTargetFunc(row);
  });
};
...
const onDelete = async () => {
  ...
  const res = await deletePromotionMarketTargetByIds({ ids });
  if (res.code === 0) {
    ElMessage({
      type: "success",
      message: "删除成功",
...
// 更新行
const updatePromotionMarketTargetFunc = async (row) => {
  const res = await findPromotionMarketTarget({ ID: row.ID });
  type.value = "update";
  if (res.code === 0) {
...
// 删除行
const deletePromotionMarketTargetFunc = async (row) => {
  const res = await deletePromotionMarketTarget({ ID: row.ID });
  if (res.code === 0) {
    ElMessage({
      type: "success",
      message: "删除成功",
