  ...
  <div class="flex items-center gap-4 mx-4">
    <el-tooltip class="" effect="dark" content="视频教程" placement="bottom">
      <el-dropdown @command="toDoc">
        <el-icon
          class="w-8 h-8 border border-gray-200 border-solid rounded-full shadow cursor-pointer dark:border-gray-600"
        >
          <Film />
        </el-icon>
    ...
    >
      <el-icon
        ...
        class="w-8 h-8 border border-gray-600 border-solid rounded-full shadow cursor-pointer"
      ...
      <el-icon
        v-else
        class="w-8 h-8 border border-gray-200 border-solid rounded-full shadow cursor-pointer"
