...
<template>
  <div
    class="fixed top-0 left-0 right-0 z-10 flex items-center justify-between h-16 px-2 bg-white shadow text-slate-700 dark:text-slate-300 dark:bg-slate-900 dark:shadow-gray-700"
  >
    <div class="flex items-center flex-1 cursor-pointer">
      ...
      >
        ...
        <div
          v-if="!isMobile"
          class="inline-flex ml-2 text-2xl font-bold"
          :class="
    ...
    <div class="flex items-center ml-2">
      ...
      <el-dropdown>
        <div class="flex items-center justify-center w-full h-full">
          <span
            class="flex items-center justify-center text-black cursor-pointer dark:text-gray-100"
          >
            <CustomPic />
