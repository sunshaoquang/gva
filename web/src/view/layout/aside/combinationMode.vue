<template>
  <div class="h-full">
    ...
    <div
      v-if="mode === 'normal'"
      class="relative h-full bg-white border-r shadow text-slate-700 dark:text-slate-300 dark:bg-slate-900 dark:shadow-gray-700"
    ...
    >
      ...
      <div
        class="absolute flex items-center justify-center w-8 h-8 rounded cursor-pointer bottom-8 right-2 bg-gray-50 dark:bg-slate-800"
