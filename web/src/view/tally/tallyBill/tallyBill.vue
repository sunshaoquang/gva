<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="分类图标" prop="icon" width="120" />
        <el-table-column align="left" label="分类名称" prop="name" width="120" />
        <el-table-column align="left" label="交付方式" prop="deliveryMethod" width="120" />
        <el-table-column align="left" label="账单金额" prop="money" width="120" />
        <el-table-column align="left" label="备注" prop="tag" width="120" />
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateTallyBillFunc(scope.row)">变更</el-button>
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="交付方式:"  prop="deliveryMethod" >
                <el-select v-model="formData.deliveryMethod" placeholder="请选择交付方式" style="width:100%" :clearable="true" >
...
const getTableData = async() => {
  const table = await getTallyBillList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
