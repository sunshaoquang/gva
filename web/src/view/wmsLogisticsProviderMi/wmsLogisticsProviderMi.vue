<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" show-overflow-tooltip label="供应商" prop="supplier" width="120" />
        ...
        <el-table-column fixed="right" width="300" align="left" show-overflow-tooltip label="操作">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateWmsLogisticsProviderMiFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type==='create'?'添加':'修改'" destroy-on-close>
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="供应商:"  prop="supplier" >
              <el-input v-model="formData.supplier" :clearable="true"  placeholder="请输入供应商" />
            </el-form-item>
...
const getTableData = async() => {
  const table = await getWmsLogisticsProviderMiList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
