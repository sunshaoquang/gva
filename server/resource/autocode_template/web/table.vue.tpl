<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        {{- range .Fields}}
        {{- if .DictType}}
        <el-table-column {{- if .Sort}} sortable{{- end}} align="left" show-overflow-tooltip label="{{.FieldDesc}}" prop="{{.FieldJson}}" width="120">
        ...
        <el-table-column {{- if .Sort}} sortable{{- end}} align="left" show-overflow-tooltip label="{{.FieldDesc}}" prop="{{.FieldJson}}" width="120">
         ...
         {{- else if eq .FieldType "time.Time" }}
         <el-table-column {{- if .Sort}} sortable{{- end}} align="left" show-overflow-tooltip label="{{.FieldDesc}}" width="180">
