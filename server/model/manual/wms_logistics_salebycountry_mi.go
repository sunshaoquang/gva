// 自动生成模板WmsLogisticsSalebycountryMi
package manual
...
// 收入by国家 结构体  WmsLogisticsSalebycountryMi
type WmsLogisticsSalebycountryMi struct {
      global.GVA_MODEL
...
// TableName 收入by国家 WmsLogisticsSalebycountryMi自定义表名 wms_logistics_salebycountry_mi
func (WmsLogisticsSalebycountryMi) TableName() string {
  return "wms_logistics_salebycountry_mi"
}
