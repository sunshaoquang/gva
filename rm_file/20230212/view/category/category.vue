<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="分类标题" prop="name" width="120" />
        <el-table-column align="left" label="未选中分类图标" prop="icon" width="120" />
        <el-table-column align="left" label="分类父字段id" prop="categoryPar" width="120" />
        <el-table-column align="left" label="分类状态" prop="state" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.state) }}</template>
        </el-table-column>
        <el-table-column align="left" label="备注" prop="remark" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateCategoryFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="分类父字段id:"  prop="categoryPar" >
          <el-input v-model.number="formData.categoryPar" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="分类状态:"  prop="state" >
